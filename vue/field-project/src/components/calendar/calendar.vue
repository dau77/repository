...
export default {
    ...
    props: {
        ...
        months: {
            type: Array,
            default: function() {
                return this.defines.locale == 'zh-cn'
                    ? [
                          '一月',
                          '二月',
                          '三月',
    ...
    methods: {
            ...
            for (i = 1; i <= lastDateOfMonth; i++) {
                ...
                if (this.range) {
                    ...
                    if (this.begin.length > 0) {
                        ...
                        if (
                            beginTime >
                            Number(new Date(this.year, this.month, i))
                        )
                    ...
                    if (this.end.length > 0) {
                        ...
                        if (
                            endTime < Number(new Date(this.year, this.month, i))
                        )
                            options.disabled = true
                    }
        ...
        getEvents(y, m, d) {
            ...
            if (eventName != undefined) {
                ...
                // console.log('自定义事件中标记的日期：'+ y + '-' + m + '-' + d +':'+eventName);
            }
            return data
        },
        // 上月
